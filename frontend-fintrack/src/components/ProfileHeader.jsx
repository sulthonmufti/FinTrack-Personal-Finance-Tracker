...
export default function ProfileHeader() {
  ...
  return (
    <Link 
      to="/edit-profile" 
      className="flex items-center gap-3 bg-white p-1.5 pr-4 rounded-full border border-slate-200 shadow-sm transition-all hover:shadow-md hover:border-indigo-200 cursor-pointer group"
    >
